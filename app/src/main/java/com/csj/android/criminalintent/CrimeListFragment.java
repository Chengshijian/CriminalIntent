...
public class CrimeListFragment extends Fragment {
    ...
    private static final String SAVED_SUBTITLE_VISIBLE = "com.csj.android.criminalintent.subtitle";
    ...
    private void deleteAllInfo() {
        CrimeLab crimeLab = CrimeLab.getCrimeLabInstance(getActivity());
        crimeLab.deleteAllCrimes();
    }

    private void addCrimeInfo() {
        Crime crime = new Crime();
        CrimeLab.getCrimeLabInstance(getActivity()).addCrime(crime);
